...
| 7. SacredNumberWheel | *NEW* | Not Started |
| 8. Testing & Polish | [SG-292](https://linear.app/sherpagg/issue/SG-292) | Not Started |
...
│   ├── sacred-number-wheel.tsx    # Circular digit input (ritual experience) — Phase 7
│   ├── input-mode-toggle.tsx      # Toggle between NumberPad/Wheel — Phase 7
...
│   ├── use-sightings.ts           # React Query: list + mutations
│   ├── use-stats.ts               # React Query: user statistics
│   └── use-interpretation.ts      # React Query: regenerate mutation
└── lib/signal/
...
| Data fetching | React Query (TanStack Query) | Better mutation handling, cache invalidation, TypeScript DX |
...
| Input modes | NumberPad first, SacredNumberWheel in Phase 7 | Validate flow before adding ritual UI |
| Rate limiting | In-memory per userId | Sufficient for beta; upgrade to Redis when scaling |
| Interpretation regeneration | Upsert (overwrite) | Simpler schema, history not needed for v1 |
| Testing | API routes + component logic | High-value coverage without E2E maintenance |
...
| `@tanstack/react-query` | Data fetching & mutations | Phase 3 |
...
| [hooks.md](./hooks.md) | React Query hooks for data fetching |
| [claude.md](./claude.md) | Claude API integration, prompts, fallbacks |

### Phase Docs (How to Build It)

| Phase | Focus | Doc | Linear |
|-------|-------|-----|--------|
| 1 | Foundation | [phases/1-foundation.md](./phases/1-foundation.md) | [SG-286](https://linear.app/sherpagg/issue/SG-286) |
| 2 | Data Layer | [phases/2-data-layer.md](./phases/2-data-layer.md) | [SG-287](https://linear.app/sherpagg/issue/SG-287) |
| 3 | Hooks & State | [phases/3-hooks-state.md](./phases/3-hooks-state.md) | [SG-288](https://linear.app/sherpagg/issue/SG-288) |
| 4 | UI Components | [phases/4-ui-components.md](./phases/4-ui-components.md) | [SG-289](https://linear.app/sherpagg/issue/SG-289) |
| 5 | Pages | [phases/5-pages.md](./phases/5-pages.md) | [SG-290](https://linear.app/sherpagg/issue/SG-290) |
| 6 | Integration | [phases/6-integration.md](./phases/6-integration.md) | [SG-291](https://linear.app/sherpagg/issue/SG-291) |
| 7 | SacredNumberWheel | [phases/7-sacred-number-wheel.md](./phases/7-sacred-number-wheel.md) | *NEW* |
| 8 | Testing & Polish | [phases/8-testing-polish.md](./phases/8-testing-polish.md) | [SG-292](https://linear.app/sherpagg/issue/SG-292) |
