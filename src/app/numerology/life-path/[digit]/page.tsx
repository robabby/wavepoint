...
export async function generateMetadata({
  ...
  return generatePositionDigitMetadata("life-path", digit);
}

export default async function LifePathDigitPage({
  params,
}: {
  params: Promise<{ digit: string }>;
}) {
  const { digit } = await params;
  return <PositionDigitPage positionSlug="life-path" digitParam={digit} />;
}
