...
export async function generateMetadata({
  ...
  return generatePositionDigitMetadata("soul-urge", digit);
}

export default async function SoulUrgeDigitPage({
  params,
}: {
  params: Promise<{ digit: string }>;
}) {
  const { digit } = await params;
  return <PositionDigitPage positionSlug="soul-urge" digitParam={digit} />;
}
